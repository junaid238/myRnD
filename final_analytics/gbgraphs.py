...
data_file = '/home/khan/gb_data.xlsx'
...
plt.pyplot.title('DataHub Monthly analysis at GB')
...
plt.pyplot.title('DataHub Status at GB')
...
plt.pyplot.title('Courses of  students at GB')
...
new_df.insert(6, "category", techlist)
...
writer = pd.ExcelWriter('gbdataPython.xlsx', engine='xlsxwriter')
...
plt.pyplot.title('DataHub students at GB')
